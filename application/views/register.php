    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form>
          ...
          <a class="btn btn-primary btn-block" href="http://localhost/cifirst/login">Register</a>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="http://localhost/cifirst/login">Login Page</a>
          <a class="d-block small" href="http://localhost/cifirst/forgot">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
